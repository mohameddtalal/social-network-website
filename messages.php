    ...
    <div class="main_column column" id="main_column">
        ...
        <div class="message_post">
            <form action="" method="POST">
                <?php 
                if($user_to == "new"){
                    echo "Select the friend you would like yo message <br><br>";
                    ?> 
                    ...
                    echo "<textarea name='message_body' id='message-textarea' placeholder='Write your message ...'></textarea>";
